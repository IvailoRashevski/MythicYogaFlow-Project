...
class HunamanViewController: UIViewController {
    ...
    @IBAction func mvmBtn(_ sender: Any) {
        playerFunc(url: "https://storage.googleapis.com/mythic-yoga-flow/Content/videos/09_HANUMAN/09_HANUMAN_MOVEMENT_1280x720_23.976FPS.mp4")
    }
    ...
    @IBAction func mythBtn(_ sender: Any) {
        playerFunc(url: "https://storage.googleapis.com/mythic-yoga-flow/Content/videos/09_HANUMAN/09_HANUMAN_MYTH_1280x720_23.976FPS.mp4")
    }
    ...
    @IBAction func mudraBtn(_ sender: Any) {
        playerFunc(url: "https://storage.googleapis.com/mythic-yoga-flow/Content/videos/09_HANUMAN/09_HANUMAN_MUDRA_1280x720_23.976FPS.mp4")
    }
    ...
    @IBAction func pyaBtn(_ sender: Any) {
        playerFunc(url: "https://storage.googleapis.com/mythic-yoga-flow/Content/videos/09_HANUMAN/09_HANUMAN_PRANAYAMA_1280x720_23.976FPS.mp4")
    }
    ...
    @IBAction func mantraBtn(_ sender: Any) {
        playerFunc(url: "https://storage.googleapis.com/mythic-yoga-flow/Content/videos/09_HANUMAN/09_HANUMAN_MANTRA_1280x720_23.976FPS.mp4")
    }
    ...
    @IBAction func tipBtn(_ sender: Any) {
        playerFunc(url: "https://storage.googleapis.com/mythic-yoga-flow/Content/videos/09_HANUMAN/09_HANUMAN_TEACHING_TIP_1280x720_23.976FPS.mp4")
    }
